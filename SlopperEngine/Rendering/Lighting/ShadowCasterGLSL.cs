...
{
    /// <summary>
    /// The view projection matrix of the shadow caster. Should project everything into a 1x1x1 cube. This field exists four times on the OpenGL side.
    /// </summary>
    [FieldOffset(0)]
