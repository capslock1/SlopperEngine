...
namespace SlopperEngine.Rendering.PostProcessing;
...
public class Bloom : IDisposable
{
    ...
    /// <param name="mipCount">The amount of mips to use. If <0, it will be automatically set to cause the lowest mip to be ~10*10 pixels in size.</param>
